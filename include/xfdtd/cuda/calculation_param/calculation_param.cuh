#ifndef __XFDTD_CORE_CUDA_CALCULATION_PARAM_MATERIAL_PARAM_CUH__
#define __XFDTD_CORE_CUDA_CALCULATION_PARAM_MATERIAL_PARAM_CUH__
...
class CalculationParam {
 ...
 public:
  ...
  XFDTD_CORE_CUDA_DUAL auto timeParam() const -> const TimeParam* {
    return _time_param;
  }

  XFDTD_CORE_CUDA_DUAL auto materialParam() const -> const MaterialParam* {
    return _material_param;
  }

  XFDTD_CORE_CUDA_DUAL auto fdtdCoefficient() const -> const FDTDCoefficient* {
    return _fdtd_coefficient;
  }

  XFDTD_CORE_CUDA_DUAL auto timeParam() -> TimeParam* { return _time_param; }

  XFDTD_CORE_CUDA_DUAL auto materialParam() -> MaterialParam* {
    return _material_param;
  }

  XFDTD_CORE_CUDA_DUAL auto fdtdCoefficient() -> FDTDCoefficient* {
    return _fdtd_coefficient;
  }

  XFDTD_CORE_CUDA_DUAL auto setTimeParam(TimeParam* time_param) {
    _time_param = time_param;
  }

  XFDTD_CORE_CUDA_DUAL auto setMaterialParam(MaterialParam* material_param) {
    _material_param = material_param;
  }

  XFDTD_CORE_CUDA_DUAL auto setFDTDCoefficient(
      FDTDCoefficient* fdtd_coefficient) {
    _fdtd_coefficient = fdtd_coefficient;
  }
...
#endif  // __XFDTD_CORE_CUDA_CALCULATION_PARAM_MATERIAL_PARAM_CUH__
