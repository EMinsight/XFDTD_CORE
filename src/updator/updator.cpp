...
void BasicUpdator::updateH() {
  ...
  // if (_calculation_param->timeParam()->currentTimeStep() > 2400) {
  //   auto hx_view{xt::view(hx, 0, xt::all(), xt::all())};
  //   auto hy_view{xt::view(hy, 0, xt::all(), xt::all())};
  //   auto hz_view{xt::view(hz, 0, xt::all(), xt::all())};
  //   std::cout << "\n" << xt::amax(hx_view) << '\n';
  //   std::cout << xt::amax(hy_view) << '\n';
  //   std::cout << xt::amax(hz_view) << '\n';
  // }
}
...
void BasicUpdator3D::updateE() {
  ...
  if (_calculation_param->timeParam()->currentTimeStep() > 2400) {
    auto hx_view{xt::view(ex, 1, xt::all(), xt::all())};
    auto hy_view{xt::view(ey, 1, xt::all(), xt::all())};
    auto hz_view{xt::view(ez, 1, xt::all(), xt::all())};
    // std::cout << "\nE: " << xt::amax(hx_view) << '\n';
    // std::cout << xt::amax(hy_view) << '\n';
    // std::cout << xt::amax(hz_view) << '\n';
  }
