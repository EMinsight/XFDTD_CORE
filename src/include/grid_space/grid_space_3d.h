...
class GridSpace3D : public GridSpace {
 public:
  ...
  GridSpace3D(Type type, GridSpaceRegion region, GridBox global_box,
              double based_dx, double based_dy, double based_dz, double min_dx,
              double min_dy, double min_dz, xt::xarray<double> e_node_x,
              xt::xarray<double> e_node_y, xt::xarray<double> e_node_z,
