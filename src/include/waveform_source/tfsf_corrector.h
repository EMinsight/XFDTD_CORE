...
class TFSFCorrector : public WaveformSourceCorrector {
 public:
  TFSFCorrector(Grid global_start, std::shared_ptr<GridSpace> grid_space,
                ...
                IndexTask global_ey_task_xn,
                IndexTask global_ez_task_xn,
                IndexTask global_ey_task_xp,
                IndexTask global_ez_task_xp,
                IndexTask global_ez_task_yn,
                IndexTask global_ex_task_yn,
                IndexTask global_ez_task_yp,
                IndexTask global_ex_task_yp,
                IndexTask global_ex_task_zn,
                IndexTask global_ey_task_zn,
                IndexTask global_ex_task_zp,
                IndexTask global_ey_task_zp,
                ...
                const Array1D<Real>& projection_z_half,
                Array1D<Real>& ex_inc, Array1D<Real>& ey_inc,
                Array1D<Real>& ez_inc, Array1D<Real>& hx_inc,
                Array1D<Real>& hy_inc, Array1D<Real>& hz_inc,
                Real cax, Real cbx, Real cay, Real cby, Real caz,
                Real cbz)
